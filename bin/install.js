#!/usr/bin/env node
/**
 * @yottameta/yotta-publish-guard cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-publish-guard --agent <name>
 *   npx -y @yottameta/yotta-publish-guard --dir <path>
 *   npx -y @yottameta/yotta-publish-guard -g
 *   npx -y @yottameta/yotta-publish-guard
 *   npx -y @yottameta/yotta-publish-guard --list
 */
'use strict';
...
const SKILL_NAME = 'yotta-publish-guard';
...
function usage() {
  console.log('yotta-publish-guard installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-publish-guard --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-publish-guard --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-publish-guard -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-publish-guard                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-publish-guard --list           List supported agent directories');
  console.log('');
  console.log('Options:');
